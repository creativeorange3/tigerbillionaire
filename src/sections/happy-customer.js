        ...
        <Box sx={styles.contentWrapper}>
          <Box sx={styles.rightContent}>
            <SectionHeading
              emoji={emoji}
              sx={styles.heading}
              title="Making hosts happy all around the world"
              description="Doesn't matter where you are and how many properties you have - everyone is equally important! Any host can become our partner and receive products!"
            />
          </Box>
        </Box>
      </Container>
